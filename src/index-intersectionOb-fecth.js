/*
    Este codigo es el mismo que index.js solo que no funciono obtener la imagen en loadImage (lazy.js)
    en el entry.target el innterHTML no contenia la imagen
*/
